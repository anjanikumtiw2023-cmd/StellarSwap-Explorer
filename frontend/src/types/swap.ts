...
export type ConfirmedSwap = { fromCode: string; toCode: string; sentAmount: string; receivedAmount: string | null; timestamp: Date; hash: string; explorerUrl: string; status: 'success' }
